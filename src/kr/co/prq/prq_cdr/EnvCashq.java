...
public class EnvCashq {
	...
	private static EnvCashq Instance = null;
	private EnvCashq() {
		Instance = this;
	}
	 ...
	 * @return
	 */
	public static EnvCashq getInstance() {
		if(Instance == null)
		{
			Instance = new EnvCashq();
	...
	private static Properties loadEnvFile() {
		...
		try {
			...
			properties.loadFromXML(new FileInputStream(PRQ_CDR.strPrePath + "cashq_env.xml"));
