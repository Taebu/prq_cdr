 ...
 * @author Taebu
	 * 
	 */
public class MyDataObjectCashq {
		...
		public void openPstmt(String str) throws SQLException {
			pstmt_str = str;
			pstmt = DBConnCashq.getConnection().prepareStatement(str);
		}
		...
		private void pstmtClose() {
			try {
				...
				DBConnCashq.latest_warning = "ErrPOS022";
			}
			catch (Exception e) {
				Utils.getLogger().warning(e.getMessage());
				Utils.getLogger().warning(Utils.stack(e));
				DBConnCashq.latest_warning = "ErrPOS023";
			}
			...
			try {
				...
				Utils.getLogger().warning(e.getMessage());
				DBConnCashq.latest_warning = "ErrPOS024";
			}
			catch (Exception e) {
				Utils.getLogger().warning(e.getMessage());
				Utils.getLogger().warning(Utils.stack(e));
				DBConnCashq.latest_warning = "ErrPOS025";
			}
		}
		...
		protected void finalize() throws Throwable {
			if (pstmt != null) {
				...
				DBConnCashq.latest_warning = "ErrPOS026";
			}
		}
